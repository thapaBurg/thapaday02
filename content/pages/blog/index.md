...
topSections:
  ...
  - type: GenericSection
    title:
      type: TitleBlock
      text: 'Video 1: How to apply to US?'
      color: text-dark
      styles:
        self:
          textAlign: left
    subtitle: Easy step-by-step example guide to apply
    text: "**Watch this video for detailed instructions for Lyon College**\n\n**STEP 1**:\_Go to\_Lyon.edu and click on **Apply**\n\n**STEP 2**:\_“Create an account”. You will receive a Temporary pin in your email.\n\n**STEP 3**:\_Log in again and begin the application.\n\nList of documents you will need: Passport, High school transcripts (10,11,12), English Test (IELTS, DUO, etc.), Bank Statement, and more\n\nWhen you get to “**Lyon Specific questions**” page, you will see “**If you have been recruited by an agent**?“, make sure to select\_**Dr. Samrat\nThapa**. You will receive lot of help from me.\n\n**STEP 4**:\_Once you submit your application email me (<DrSamratThapa@gmail.com>).\n\n**STEP 5**:\_Fill form below, and Dr. Thapa will make sure your application is processed in a timely fashion.[ https://forms.gle/ZBLxnfjxAeZbUpqi9](https://forms.gle/ZBLxnfjxAeZbUpqi9)\n"
    actions: []
    media:
      type: VideoBlock
      title: Title of the video
      url: 'https://youtu.be/jrjGcZIBCHY'
      autoplay: false
      loop: false
      muted: true
      controls: false
